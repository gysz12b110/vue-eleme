<template>
  <div class="mine">
    <div class="top">
      ...
      <div class="user cl">
        <img class="head-pic" :src="getUser.avatar" alt="">
        <div class="content">
          <div class="name">{{getUser.username}}</div>
          <div class="phone">
            <i class="icon-take icon-shouji"></i>{{getUser.phone|Phone}}</div>
        </div>
    ...
    <div class="account">
      <div class="cell">
        <p class="money">{{getUser.wallet|RMB}}
          <span class="unit">元</span>
        </p>
        <p class="text">钱包</p>
      </div>
      <div class="cell">
        <p class="number">{{getUser.coupon.length}}
          <span class="unit">个</span>
        </p>
        <p class="text">优惠</p>
      </div>
      <div class="cell">
        <p class="score">{{getUser.integral}}
