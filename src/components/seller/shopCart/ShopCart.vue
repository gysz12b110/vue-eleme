    ...
    <transition @enter="enter" @afterEnter="afterEnter" @leave="leave" @beforeEnter="beforeEnter" @beforeLeave="beforeLeave" @afterLeave="afterLeave">
      <div class="slide" v-if="showList" ref="slide">
        ...
        <ul class="goods-list">
          <li class="item cl">
            <div class="goods">
              <div class="name">脆皮鸡拌饭</div>
              <div class="content">不要辣+2份餐具</div>
            </div>
            <div class="control">
          ...
          <li class="item cl">
            <div class="goods">
              <div class="name">鸡腿汉堡</div>
              <div class="content">番茄2份</div>
            </div>
            <div class="control">
              <span class="price">&yen;30</span>
              <span class="shopping">
                <i class="icon-take icon-jian"></i>
                <span class="count">1</span>
                <i class="icon-take icon-jia"></i>
